...
abstract class _$ForumPosts extends BuildlessAsyncNotifier<List<ThreadList?>> {
  late final Snowflake channelId;

  FutureOr<List<ThreadList?>> build(
    Snowflake channelId,
  );
}
...
///
/// Copied from [ForumPosts].
class ForumPostsFamily extends Family<AsyncValue<List<ThreadList?>>> {
  /// Fetches a forum channel from the [channelId].
  ///
  /// Copied from [ForumPosts].
...
class ForumPostsProvider
    extends AsyncNotifierProviderImpl<ForumPosts, List<ThreadList?>> {
  /// Fetches a forum channel from the [channelId].
  ///
  /// Copied from [ForumPosts].
  ForumPostsProvider(
  ...
  @override
  FutureOr<List<ThreadList?>> runNotifierBuild(
  ...
  @override
  AsyncNotifierProviderElement<ForumPosts, List<ThreadList?>> createElement() {
...
mixin ForumPostsRef on AsyncNotifierProviderRef<List<ThreadList?>> {
  /// The parameter `channelId` of this provider.
  Snowflake get channelId;
}

class _ForumPostsProviderElement
    extends AsyncNotifierProviderElement<ForumPosts, List<ThreadList?>>
    with ForumPostsRef {
