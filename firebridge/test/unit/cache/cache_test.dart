...
void main() {
  group('Cache', () {
    ...
    test('respects maximum size', () async {
      ...
      final entity1 = MockSnowflakeEntity(id: Snowflake(BigInt.from(1)));
      final entity2 = MockSnowflakeEntity(
        id: Snowflake(BigInt.from(2)),
      );
      final entity3 = MockSnowflakeEntity(id: Snowflake(BigInt.from(3)));
      final entity4 = MockSnowflakeEntity(id: Snowflake(BigInt.from(4)));
      final entity5 = MockSnowflakeEntity(id: Snowflake(BigInt.from(5)));
    ...
    test('keeps most used items', () async {
      ...
      final entity1 = MockSnowflakeEntity(id: Snowflake(BigInt.from(1)));
      final entity2 = MockSnowflakeEntity(id: Snowflake(BigInt.from(2)));
      final entity3 = MockSnowflakeEntity(id: Snowflake(BigInt.from(3)));
      final entity4 = MockSnowflakeEntity(id: Snowflake(BigInt.from(4)));
      final entity5 = MockSnowflakeEntity(id: Snowflake(BigInt.from(5)));
    ...
    test("doesn't cache items if a filter is provided", () {
      final cache = Cache<MockSnowflakeEntity>(MockNyxx(), 'test',
          CacheConfig(shouldCache: (e) => e.id.value > BigInt.from(3)));
